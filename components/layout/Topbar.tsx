...
const searchablePages = [
  ...
  {
    title: "Projects",
    description: "Manage your Shelby projects",
    href: "/projects",
        ...
        <div className="relative w-full max-w-lg">
          ...
          >
            ...
            <input
              ...
              autoComplete="off"
              className="w-full rounded-xl border border-slate-800 bg-slate-900 py-3 pl-11 pr-11 text-white outline-none transition-all placeholder:text-slate-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
            />
